            ...
            <div className="relative flex flex-wrap items-center -mx-4">
              <div className="w-full lg:w-2/3 px-4 mb-12 lg:mb-0">
                <div className="max-w-lg"><span className="text-xs text-tetriary-light font-semibold">Wherever your mind goes</span>
                  ...
                  <p className="mb-6 lg:mb-12 text-xl text-gray-500">Remindle is a platform which helps you to remember all important events. You can set the means you’d like to receive the notifications and adjust the frequency according to importance levels.</p><a className="inline-block py-4 px-8 text-sm text-white font-medium leading-normal bg-primary hover:bg-secondary transition duration-200 rounded transition duration-200" href="https://remindle.io/register">Join our community</a>
                </div>
              </div>
